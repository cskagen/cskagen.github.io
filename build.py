...
HOME_BACKGROUND = "backgrounds/bg_04.jpg"
HOME_DESCRIPTION = (
...
def write_replica_list_page(items):
    lines = [
        ...
        "@media (max-width:600px){.archive-grid{grid-template-columns:repeat(16,1fr);gap:3px 2px;font-size:10px;line-height:1.25;}}",
        "</style>",
        "</head>",
        "<body>",
        '<div class="wrapper">',
...
def write_archive_page(items):
    ...
    lines = [
        ...
        head,
        "<style>",
        ".archive-grid{width:100%;max-width:1400px;margin:auto;display:grid;grid-template-columns:repeat(16,1fr);gap:4px 8px;font-size:12px;line-height:1.35;}",
